...
type ListTypeFunc<ListType extends Object> = (row: ListType) => void

export abstract class GridViewStore<ListType extends Object, ListRequestType extends GridViewListRequest, ListResponseType extends GridViewListResponse> {
    ...
    entitiesFromViewModel: (listResponse: ListResponseType) => ListType[]
    editListRequest?: (listRequest: ListRequestType, params: ListParams) => any
    @observable gridDefinition: Column<ListType>[]

    entityActionType?: EntityActionType
    @observable entityActionActive = false
    @observable selectedEntity?: ListType
    @observable totalCount = 0
    @observable rows = [] as (ListType)[]
    @observable tableActions: CustomTableActions<ListType> = {}

    @action setGridActions = ({
    ...
    @action onActionClick = (actionNameOrRowAction: (string | RowActionType<ListType>), data: ListType) => {
    ...
    @action setTotalCount = (total: number) => {
    ...
    pageSize?: number
    @action fetchRequest = async (dataFetchProps: RemoteDataFetchProps<ListType>) => {
    ...
    @action getList = async (listParams: ListParams) => {
        ...
        let listRequest = new this.listRequestType()
        listRequest.pageNumber = listParams.page + 1
